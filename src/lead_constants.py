...
the 2019-2022 period the data is modeled on. Anchor points come from
the author's SDR experience at a data security vendor.
"""
...
# Country-level conversion varies a lot more than region-level (from the
# author's SDR experience) — see COUNTRY_CONVERSION_ANCHORS below.
COUNTRIES_BY_REGION = {
...
# Logit-scale conversion modifiers. India: the author closed ~0 deals
...
# Points per activity — the author's best recollection of the real CRM lead-score
...
# present; everything else has a chance of being blank. Rates are a
